...
await context.window.fetch(base+'ai-staging-boyaki-api/health');assert.equal(calls.length,2);await context.window.fetch(base+'ai-staging-commerce-api/health');assert.equal(calls.length,3);
