...
// AI-STAGING navigation fix: legacy "open-thread" was incorrectly treated as a reaction action.
import('./open-thread-nav-v1.js?v=20260918-ai-v1').catch(err=>console.warn('open thread nav loader failed',err));

// AI-STAGING-only room UX. Viewing stays passive; speaking requires a Voice/Maker role.
import('./thread-room-v1.js?v=20260918-ai-v1').catch(err=>console.warn('thread room loader failed',err));
